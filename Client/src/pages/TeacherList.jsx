...
function Teacherist() {
  const { teachers, error, deleteStudent, updateStudent, addStudent,fetchteachers } = useSchoolManagement();
        ...
        <table className="min-w-full border table-cont border-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {teachers.length > 0 ? (
              ...
              <tr>
                <td colSpan="5" className="px-6 py-4 text-center text-sm text-gray-500">No teachers found.</td>
              </tr>
            )}
          </tbody>
        </table>
